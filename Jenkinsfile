        ...
        stage('Detect Changes') {
            steps {
                script {
                    ...
                    env.BUILD_VETS = changedFiles.any { it.startsWith("spring-petclinic-vets-service/") }
                    env.BUILD_VISITS = changedFiles.any { it.startsWith("spring-petclinic-visits-service/") }
                    env.BUILD_CUSTOMERS = changedFiles.any { it.startsWith("spring-petclinic-customers-service/") }
